                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="box box-primary">
                                <div class="box-body">
                                    <form action="<?php echo base_url('surat_keterangan_tka/proses_tambah'); ?>" method="post">
                                        <div class="card-body">

                                            <div class="form-group">
                                                <label>ID Perubahan TKA</label>
                                                <input type="text" name="id_s_tka" class="form-control" value="<?php echo $id_s_tka; ?>" readonly />
                                            </div>
                                            <div class="form-group">
                                                <label>Nama Tenaga Kerja Asing</label>
                                                <select style="width :100%" name="id_tka" class="id_tka form-control" required>
                                                    <?php foreach ($nama as $tka_id) : ?>
                                                        <option value="<?php echo $tka_id->id_tka; ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select style="width :100%" name="id_perusahaan" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                <label>Alamat Perubahan</label>
                                                <textarea type="text" name="alamat_perubahan" class="form-control" placeholder="Alamat Perubahan"></textarea>
                                            </div>
                                            <div class="form-group">
